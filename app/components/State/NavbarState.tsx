...
const Navbar = () => {
  ...
  const navLink =["Home",  "Services", "About","Blogs", "Contact"] 
  return (
    <>
      <nav className=" sticky   top-0 z-[999] flex h-[5rem]  w-screen items-center justify-center border-y-2 bg-white px-4 md:w-full md:px-0">
        <div className=" relative w-screen md:w-full md:max-w-[1280px] md:px-10  md:py-4">
          <div className="mt-0 flex flex-row justify-between space-x-8 rounded-2xl rounded-tr-none px-4 text-sm font-medium md:mr-6 md:justify-around">
            ...
            <div className="hidden items-center justify-center lg:flex gap-6">
              <a id="cta-roofing" href={`tel:${ContactInfo.tel}`}>
              <button
                id="cta-roofing"
                className="flex items-center justify-center rounded bg-main px-3 py-2 text-sm font-bold text-white duration-200 ease-in-out hover:border-2 hover:border-main hover:bg-white hover:text-black"
              >
                <FaPhoneVolume className="text-2xl mr-2" />
                <div className="">
               {ContactInfo.service1key}: <br/> <span className="text-nowrap">{ContactInfo.No}</span>
                </div>
              </button>
              </a>
              ...
              >
                <FaPhoneVolume className="text-2xl mr-2" />
               <div className="">
               {ContactInfo.service2key}: <br/> <span className="text-nowrap">{ContactInfo.No2}</span>
                </div>
              </button>
              </a>
            </div>
