...
const contactContent: any = {
  ...
  NoKeyword: getValueOrDefault(contactDataJson?.NoKeyword, ""),
  No2Keyword: getValueOrDefault(contactDataJson?.No2Keyword, ""),
  service1key: getValueOrDefault(contactDataJson?.service1key, ""),
  service2key: getValueOrDefault(contactDataJson?.service2key, ""),
  tel: getValueOrDefault(contactDataJson?.tel, "DEFAULT: +15551234567"),
  No2: getValueOrDefault(contactDataJson?.No2, "DEFAULT: (555) 123-4567"),
  tel2: getValueOrDefault(contactDataJson?.tel2, "DEFAULT: +15551234567"),
...
function replacePlaceholders(obj: any, ContactInfo: any): any {
  ...
  const safeContactInfo = {
    ...
    No2: ContactInfo?.No2 || "DEFAULT: (555) 123-4567",
    tel2: ContactInfo?.tel2 || "DEFAULT: +15551234567",
    NoKeyword: ContactInfo?.NoKeyword || "DEFAULT: For Roofing Damage Restoration Service",
    No2Keyword: ContactInfo?.No2Keyword || "DEFAULT: For Gutter Damage Restoration Service",
    service1key: ContactInfo?.service1key || "DEFAULT: For Roofing",
    service2key: ContactInfo?.service2key || "DEFAULT: For Gutter",
...
const ContactInfo = contactContent || {
  location: "DEFAULT: Your City, State",
  No: "DEFAULT: (555) 123-4567",
  NoKeyword: "DEFAULT: For Roofing Service",
  No2Keyword: "DEFAULT: For Roofing Service",
  service1key: "DEFAULT: For Roofing ",
  service2key: "DEFAULT: For Gutter ",
  tel: "DEFAULT: +15551234567",
  No2: "DEFAULT: (555) 123-4567",
  tel2: "DEFAULT: +15551234567",
  mail: "",
  baseUrl: "DEFAULT: https://waterdamagerestoration.com/",
  host: "DEFAULT: waterdamagerestoration.com",
  name: "DEFAULT: Premier Water Damage Restoration",
